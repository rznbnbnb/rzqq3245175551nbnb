...
if theme == 'dark' then
    ...
    beijingColor = Color3.fromRGB(25, 25, 25)
      ...
      DropShadow.Size = UDim2.new(1, 0, 1, 0) -- 修改为与背景相同大小
      DropShadow.Image = "rbxassetid://96613913514721" -- 修改背景图片ID
      DropShadow.ImageColor3 = Color3.fromRGB(255,255,255)
      DropShadow.SliceCenter = Rect.new(49, 49, 450, 450)
      DropShadow.ScaleType = Enum.ScaleType.Stretch -- 添加拉伸以适应背景
...
Open.Active = true
Open.Draggable = true
Open.Image = "rbxassetid://92343330923070" -- 修改悬浮窗图片ID
Open.MouseButton1Click:Connect(function()
  Main.Visible = not Main.Visible
  Open.Image = Main.Visible and "rbxassetid://92343330923070" or "rbxassetid://92343330923070" -- 修改悬浮窗图片ID
end)
